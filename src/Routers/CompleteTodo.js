...
const complete=single.filter(ele=>ele.completed===true)
    return(
      <div style={{ display: "block", padding: 30,fontSize:'18px',justifyContent:'center',alignItems:'center' }}>
      <h2 style={{textAlign:'center',marginBottom:'50px',textDecorationLine:'underline'}}>Completed ToDos Details</h2>
